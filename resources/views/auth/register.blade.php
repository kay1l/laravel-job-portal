                            ...
                            <div class="row">
                                <div class="col-xl-12">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control {{ $errors->has('name') ? 'is-invalid' : '' }}"
                                            id="input-2" type="text" required="" name="name"
                                ...
                                <div class="col-12 mb-3">
                                    ...
                                    <div class="form-check form-check-inline">
                                        ...
                                        <label class="form-check-label{{$errors->has('account_type') ? 'is-invalid' : ''}}" for="typeCandidate">Candidate</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input" type="radio" name="account_type" id="typeCompany"
                                            value="company" required >
                                        <label class="form-check-label{{$errors->has('account_type') ? 'is-invalid' : ''}}" for="typeCompany">Company</label>
                                    </div>
