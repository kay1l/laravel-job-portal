                                ...
                                <tbody>
                                    @foreach ($industryTypes as $type)
                                        <tr>
                                            ...
                                            <td>{{ $type->slug }}</td>
                                            <td>
                                                <a class="btn-sm btn-primary" href="{{route('admin.industry-types.edit', $type->id)}}"><i class="fas fa-edit"></i></a>

                                                <a  href="{{ route('admin.industry-types.destroy', $type->id)}}" class="btn-sm btn-danger delete-item"><i class="fas fa-trash"></i></a>
